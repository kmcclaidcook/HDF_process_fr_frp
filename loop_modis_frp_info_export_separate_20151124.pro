PRO Loop_MODIS_FRP_info_export_separate_20151124

CD, 'G:/data/Remote_Sensing/MODIS/AK_MOD021KM_MOD03_2004_AMJJASO'
...
FOR i=0,n_fils DO BEGIN
	...
	datafield_name='SensorZenith'
	dataset_index = HDF_SD_NameToIndex(fileID, datafield_name)
	datasetID = HDF_SD_Select(fileID, dataset_index)
	HDF_SD_GetData, datasetID, data_variable
	WRITE_TIFF, tif_name + 'SensorZenith.tif', data_variable, /FLOAT
