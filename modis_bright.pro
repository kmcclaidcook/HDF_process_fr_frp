FUNCTION MODIS_BRIGHT, RAD, BAND, UNITS, NAME=NAME

;+
; DESCRIPTION:
;    Compute brightness temperature for a MODIS infrared band on
;    Terra or Aqua.
;
...
; $Id: modis_bright.pro,v 1.5 2002/09/03 19:08:44 gumley Exp $
;
...
rcs_id = '$Id: modis_bright.pro,v 1.5 2002/09/03 19:08:44 gumley Exp $'
...
if (units eq 1) then begin
  ...
  result = (bright_m(1.0d+4 / cwn, rad) - tci) / tcs

endif else begin

  ;- Radiance units are
  ;- milliWatts per square meter per steradian per wavenumber
  result = (brite_m(cwn, rad) - tci) / tcs
