...
;
; OUTPUT PARAMETERS:
;    PLANCK_M    Planck radiance (Watts per square meter per steradian
;                per micron)
;
; MODIFICATION HISTORY:
; Liam.Gumley@ssec.wisc.edu
; http://cimss.ssec.wisc.edu/~gumley
; $Id: planck_m.pro,v 1.2 2000/03/15 20:33:51 gumley Exp $
;
...
rcs_id = '$Id: planck_m.pro,v 1.2 2000/03/15 20:33:51 gumley Exp $'
...
return, 1.0e-6 * (c1 / ws^5) / (exp(c2 / (ws * t)) - 1.0)
